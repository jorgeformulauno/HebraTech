...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2026 a las 15:45:23
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_estado_cliente` (IN `nuevo_estado` ENUM('activo','inactivo','bloqueado '), IN `codigo` INT)   BEGIN
UPDATE clientes c 
set c.estado = nuevo_estado
